            ...
            '/guide/': [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { text: 'Invoicing', link: '/guide/invoicing' },
                        { text: 'Payouts & Splits', link: '/guide/payouts' },
                        { text: 'Coupons & Discounts', link: '/guide/coupons' },
                        { text: 'Multi-Currency', link: '/guide/multi-currency' },
                        { text: 'Fraud & Risk', link: '/guide/fraud-risk' },
